...
# practice zones
# zones = {"zone1": {"source": ['left9A9', 'A8A9'], "sink": ['A9left9', 'A9A8']},"zone2": {"source": ['D5E5',
# 'E4E5'], "sink": ['E5D5', 'E5E4']}, "zone3": {"source": ['G1H1', 'H0H1'], "sink": ['H1G1', 'H1H0']}}
...
def find_pij(modified_ksp_route_matrix, edge_id):
    ...
    for i in modified_ksp_route_matrix:
        ...
        for j in modified_ksp_route_matrix[i]:
            modified_ksp_route_matrix.iloc[a][i] = sum(j)
            a = a+1
